...
from PIL import Image #pillow package  image processing
...
while True:
    ...
    if choice == 1:
        ...
        names = data.split()
        id = len(names)  # two persons (e.g. Jacob, Jack)
        print(names)
      #  print(id)


        #names = ['', 'Harsha', 'Geetha']  # key in names, start from the second place, leave first empty
